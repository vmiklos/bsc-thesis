...
alkalmazásokat csomagok (bundle) formájában lehet terjeszteni, majd a JVM
...
Az egyes csomagok olyan Java könyvtárak (JAR file-ok), amik
...
implementálhatják a csomagok, majd ha a csomagot regisztrálták  a
