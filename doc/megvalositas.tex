...
A start/0 függvény egy új processzt indít az aktuális csomóponton, mely
...
rendszer register/2 és unregister/1 függvényeit értjük, ami lehetõséget
...
A korábban hivatkozott loop/0 függvény pedig a következõ:
