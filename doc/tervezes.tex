...
implicit közlése indokolatlanul nagy hálózati forgalmat generálna. Ezt a
...
Egy használati eset például, hogy a tûzjelzõ jelez a központnak, a
...
szenzor egy Erlang csomópont, akkor is más üzenetet kell küldeni egy
...
A két probléma részben összefügg, de valójában független. Az intelligens,
...
objektumorientált környezetbe készült, míg Joe Armstrong\cite{armstrong}
