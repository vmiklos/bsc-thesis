...
\footnote{Regisztráció és regisztráció törlése alatt itt az Erlang rendszer register/2 és unregister/1 függvényeit értjük, mely lehetõséget biztosít arra, hogy az aktuális node-on Pid-ekhez atomokat rendeljünk. Ezek a regisztrációk más node-okról nem láthatóak, a teljes rendszer szintjén nem egyediek, és ezt ki is fogjuk használni.}
...
állományt, melynek aznos a formátuma a szenzoréval. A feladata
...
Ide jön majd a (teszt) környezet leírása, erlang node-ok indításának
commandline paraméterei, viaskodás a tûzfallal, stb.
